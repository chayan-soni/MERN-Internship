  ...
  return (
    <div className="app-shell">
      ...
      <section className="hero">
        <div>
          <p className="eyebrow">MERN Stack Internship - Day 17</p>
          <h2>Payment gateway integration with a demo Razorpay flow</h2>
          <p>
            Browse products, add to bag, create payment orders, verify success or failure,
            and review transaction history alongside orders and ratings.
          </p>
        </div>
