            ...
            <article key={product._id} className="product-card">
              ...
              <div className="product-content">
                ...
                <div className="review-meta">
                  <span>{product.numReviews || 0} review(s)</span>
                  <button
                    className={`inline-link ${selectedProductId === product._id ? 'active' : ''}`}
                    type="button"
                    onClick={() => onSelectProduct(product._id)}
                  >
                    {selectedProductId === product._id ? 'Viewing reviews' : 'View reviews'}
                  </button>
                </div>
              </div>
              <button
